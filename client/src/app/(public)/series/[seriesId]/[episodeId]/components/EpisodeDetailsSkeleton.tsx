            ...
            <div className="max-h-80 overflow-y-auto rounded-xl border border-border bg-background p-2">
              <div className="space-y-1">
                {Array.from({ length: 5 }).map((_, i) => (
                  ...
                  >
                    {/* Episode number */}
                    <div className="flex w-2.5 shrink-0 self-center items-center justify-center">
                    ...
                    <div className="min-w-0 flex-1 pt-0.5 space-y-2">
                      ...
                      <div className="mt-1 h-2.5 w-[55%] rounded bg-muted" />
                    </div>
                  </div>
                ))}
              </div>
          ...
          <div className="rounded-xl border border-border bg-muted/20 overflow-hidden">
            ...
            <div className="p-2 space-y-1">
              {Array.from({ length: 8 }).map((_, i) => (
                <div
                  key={i}
                  className="flex items-start gap-2 rounded-lg p-1 lg:p-2"
                >
                  {/* Episode number */}
                  <div className="flex w-2.5 lg:w-5 shrink-0 self-center items-center justify-center">
                    <div className="h-3 w-3 rounded bg-muted" />
                  </div>
